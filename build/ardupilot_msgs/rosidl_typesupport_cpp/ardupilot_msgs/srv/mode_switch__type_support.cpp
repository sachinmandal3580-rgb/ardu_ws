...
static const _ModeSwitch_Event_type_support_symbol_names_t _ModeSwitch_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ardupilot_msgs, srv, ModeSwitch_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ardupilot_msgs, srv, ModeSwitch_Event)),
  }
};
...
{
  return &::ardupilot_msgs::srv::rosidl_typesupport_cpp::ModeSwitch_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ardupilot_msgs, srv, ModeSwitch_Event)() {
  return get_message_type_support_handle<ardupilot_msgs::srv::ModeSwitch_Event>();
}
...
static const rosidl_service_type_support_t ModeSwitch_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ardupilot_msgs::srv::ModeSwitch_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ardupilot_msgs::srv::ModeSwitch_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ardupilot_msgs::srv::ModeSwitch_Event>(),
