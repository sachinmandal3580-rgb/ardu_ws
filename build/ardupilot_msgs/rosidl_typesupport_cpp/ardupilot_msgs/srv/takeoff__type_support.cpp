...
static const _Takeoff_Request_type_support_symbol_names_t _Takeoff_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ardupilot_msgs, srv, Takeoff_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ardupilot_msgs, srv, Takeoff_Request)),
  }
};
...
{
  return &::ardupilot_msgs::srv::rosidl_typesupport_cpp::Takeoff_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ardupilot_msgs, srv, Takeoff_Request)() {
  return get_message_type_support_handle<ardupilot_msgs::srv::Takeoff_Request>();
}
...
static const _Takeoff_Response_type_support_symbol_names_t _Takeoff_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ardupilot_msgs, srv, Takeoff_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ardupilot_msgs, srv, Takeoff_Response)),
  }
};
...
{
  return &::ardupilot_msgs::srv::rosidl_typesupport_cpp::Takeoff_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ardupilot_msgs, srv, Takeoff_Response)() {
  return get_message_type_support_handle<ardupilot_msgs::srv::Takeoff_Response>();
}
...
static const _Takeoff_Event_type_support_symbol_names_t _Takeoff_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ardupilot_msgs, srv, Takeoff_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ardupilot_msgs, srv, Takeoff_Event)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<ardupilot_msgs::srv::Takeoff_Event>()
{
  return &::ardupilot_msgs::srv::rosidl_typesupport_cpp::Takeoff_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ardupilot_msgs, srv, Takeoff_Event)() {
  return get_message_type_support_handle<ardupilot_msgs::srv::Takeoff_Event>();
}
...
static const _Takeoff_type_support_symbol_names_t _Takeoff_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ardupilot_msgs, srv, Takeoff)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ardupilot_msgs, srv, Takeoff)),
  }
};
...
static const rosidl_service_type_support_t Takeoff_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ardupilot_msgs::srv::Takeoff_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ardupilot_msgs::srv::Takeoff_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ardupilot_msgs::srv::Takeoff_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<ardupilot_msgs::srv::Takeoff>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<ardupilot_msgs::srv::Takeoff>,
...
{
  return &::ardupilot_msgs::srv::rosidl_typesupport_cpp::Takeoff_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, ardupilot_msgs, srv, Takeoff)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<ardupilot_msgs::srv::Takeoff>();
}
