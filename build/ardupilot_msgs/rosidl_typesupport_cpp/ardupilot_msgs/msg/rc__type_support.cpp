...
static const _Rc_type_support_symbol_names_t _Rc_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ardupilot_msgs, msg, Rc)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ardupilot_msgs, msg, Rc)),
  }
};
...
{
  return &::ardupilot_msgs::msg::rosidl_typesupport_cpp::Rc_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ardupilot_msgs, msg, Rc)() {
  return get_message_type_support_handle<ardupilot_msgs::msg::Rc>();
}
