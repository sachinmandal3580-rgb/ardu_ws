...
bool cdr_serialize_ardupilot_msgs__srv__Takeoff_Request(
  const ardupilot_msgs__srv__Takeoff_Request * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ardupilot_msgs
bool cdr_deserialize_ardupilot_msgs__srv__Takeoff_Request(
  eprosima::fastcdr::Cdr & cdr,
  ardupilot_msgs__srv__Takeoff_Request * ros_message)
{
  // Field name: alt
  {
    cdr >> ros_message->alt;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ardupilot_msgs
bool cdr_serialize_key_ardupilot_msgs__srv__Takeoff_Request(
  const ardupilot_msgs__srv__Takeoff_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: alt
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ardupilot_msgs
size_t get_serialized_size_key_ardupilot_msgs__srv__Takeoff_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Takeoff_Request__ros_msg_type * ros_message = static_cast<const _Takeoff_Request__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ardupilot_msgs
size_t max_serialized_size_key_ardupilot_msgs__srv__Takeoff_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ardupilot_msgs__srv__Takeoff_Request * ros_message = static_cast<const ardupilot_msgs__srv__Takeoff_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ardupilot_msgs__srv__Takeoff_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ardupilot_msgs__srv__Takeoff_Request * ros_message = static_cast<ardupilot_msgs__srv__Takeoff_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ardupilot_msgs__srv__Takeoff_Request(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ardupilot_msgs
bool cdr_serialize_ardupilot_msgs__srv__Takeoff_Response(
  const ardupilot_msgs__srv__Takeoff_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: status
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ardupilot_msgs
bool cdr_deserialize_ardupilot_msgs__srv__Takeoff_Response(
  eprosima::fastcdr::Cdr & cdr,
  ardupilot_msgs__srv__Takeoff_Response * ros_message)
{
  // Field name: status
  {
    uint8_t tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ardupilot_msgs
bool cdr_serialize_key_ardupilot_msgs__srv__Takeoff_Response(
  const ardupilot_msgs__srv__Takeoff_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: status
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ardupilot_msgs
size_t get_serialized_size_key_ardupilot_msgs__srv__Takeoff_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Takeoff_Response__ros_msg_type * ros_message = static_cast<const _Takeoff_Response__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ardupilot_msgs
size_t max_serialized_size_key_ardupilot_msgs__srv__Takeoff_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ardupilot_msgs__srv__Takeoff_Response * ros_message = static_cast<const ardupilot_msgs__srv__Takeoff_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ardupilot_msgs__srv__Takeoff_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ardupilot_msgs__srv__Takeoff_Response * ros_message = static_cast<ardupilot_msgs__srv__Takeoff_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ardupilot_msgs__srv__Takeoff_Response(cdr, ros_message);
}
...
using _Takeoff_Event__ros_msg_type = ardupilot_msgs__srv__Takeoff_Event;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ardupilot_msgs
bool cdr_serialize_ardupilot_msgs__srv__Takeoff_Event(
  const ardupilot_msgs__srv__Takeoff_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_ardupilot_msgs__srv__Takeoff_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_ardupilot_msgs__srv__Takeoff_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ardupilot_msgs
bool cdr_deserialize_ardupilot_msgs__srv__Takeoff_Event(
  eprosima::fastcdr::Cdr & cdr,
  ardupilot_msgs__srv__Takeoff_Event * ros_message)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      ardupilot_msgs__srv__Takeoff_Request__Sequence__fini(&ros_message->request);
    }
    if (!ardupilot_msgs__srv__Takeoff_Request__Sequence__init(&ros_message->request, size)) {
      fprintf(stderr, "failed to create array for field 'request'");
      return false;
    }
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_ardupilot_msgs__srv__Takeoff_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      ardupilot_msgs__srv__Takeoff_Response__Sequence__fini(&ros_message->response);
    }
    if (!ardupilot_msgs__srv__Takeoff_Response__Sequence__init(&ros_message->response, size)) {
      fprintf(stderr, "failed to create array for field 'response'");
      return false;
    }
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_ardupilot_msgs__srv__Takeoff_Response(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ardupilot_msgs
size_t get_serialized_size_ardupilot_msgs__srv__Takeoff_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ardupilot_msgs__srv__Takeoff_Request(
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ardupilot_msgs__srv__Takeoff_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ardupilot_msgs
size_t max_serialized_size_ardupilot_msgs__srv__Takeoff_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ardupilot_msgs__srv__Takeoff_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ardupilot_msgs__srv__Takeoff_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ardupilot_msgs__srv__Takeoff_Event;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ardupilot_msgs
bool cdr_serialize_key_ardupilot_msgs__srv__Takeoff_Event(
  const ardupilot_msgs__srv__Takeoff_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_ardupilot_msgs__srv__Takeoff_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_ardupilot_msgs__srv__Takeoff_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ardupilot_msgs
size_t get_serialized_size_key_ardupilot_msgs__srv__Takeoff_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Takeoff_Event__ros_msg_type * ros_message = static_cast<const _Takeoff_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_ardupilot_msgs__srv__Takeoff_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_ardupilot_msgs__srv__Takeoff_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ardupilot_msgs
size_t max_serialized_size_key_ardupilot_msgs__srv__Takeoff_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ardupilot_msgs__srv__Takeoff_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ardupilot_msgs__srv__Takeoff_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ardupilot_msgs__srv__Takeoff_Event * ros_message = static_cast<const ardupilot_msgs__srv__Takeoff_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ardupilot_msgs__srv__Takeoff_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ardupilot_msgs__srv__Takeoff_Event * ros_message = static_cast<ardupilot_msgs__srv__Takeoff_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ardupilot_msgs__srv__Takeoff_Event(cdr, ros_message);
}

static uint32_t _Takeoff_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ardupilot_msgs__srv__Takeoff_Event(
      untyped_ros_message, 0));
}
...
static size_t _Takeoff_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ardupilot_msgs__srv__Takeoff_Event(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ardupilot_msgs, srv, Takeoff_Event)() {
