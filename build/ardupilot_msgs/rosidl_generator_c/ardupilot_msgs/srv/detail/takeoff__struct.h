...
enum
{
  ardupilot_msgs__srv__Takeoff_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ardupilot_msgs__srv__Takeoff_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/Takeoff in the package ardupilot_msgs.
typedef struct ardupilot_msgs__srv__Takeoff_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ardupilot_msgs__srv__Takeoff_Request__Sequence request;
  ardupilot_msgs__srv__Takeoff_Response__Sequence response;
} ardupilot_msgs__srv__Takeoff_Event;

// Struct for a sequence of ardupilot_msgs__srv__Takeoff_Event.
typedef struct ardupilot_msgs__srv__Takeoff_Event__Sequence
{
