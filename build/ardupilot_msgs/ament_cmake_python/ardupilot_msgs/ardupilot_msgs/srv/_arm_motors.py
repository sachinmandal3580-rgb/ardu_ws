...
class Metaclass_ArmMotors_Event(type):
    """Metaclass of message 'ArmMotors_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__arm_motors__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__arm_motors__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__arm_motors__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__arm_motors__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__arm_motors__event
...
class ArmMotors_Event(metaclass=Metaclass_ArmMotors_Event):
    """Message class 'ArmMotors_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ardupilot_msgs/ArmMotors_Request, 1>',
        'response': 'sequence<ardupilot_msgs/ArmMotors_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ardupilot_msgs', 'srv'], 'ArmMotors_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ardupilot_msgs', 'srv'], 'ArmMotors_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ardupilot_msgs.srv import ArmMotors_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, ArmMotors_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ArmMotors_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from ardupilot_msgs.srv import ArmMotors_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ArmMotors_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ArmMotors_Response'"
...
class Metaclass_ArmMotors(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _arm_motors.Metaclass_ArmMotors_Event._TYPE_SUPPORT is None:
                _arm_motors.Metaclass_ArmMotors_Event.__import_type_support__()
...
class ArmMotors(metaclass=Metaclass_ArmMotors):
    ...
    from ardupilot_msgs.srv._arm_motors import ArmMotors_Event as Event
