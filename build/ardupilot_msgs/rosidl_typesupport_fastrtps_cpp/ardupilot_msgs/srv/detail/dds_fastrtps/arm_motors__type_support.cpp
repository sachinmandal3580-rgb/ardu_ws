...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ardupilot_msgs
max_serialized_size_key_ArmMotors_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ardupilot_msgs
max_serialized_size_key_ArmMotors_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
// functions for ardupilot_msgs::srv::ArmMotors_Request already declared above

// functions for ardupilot_msgs::srv::ArmMotors_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ardupilot_msgs
cdr_serialize(
  const ardupilot_msgs::srv::ArmMotors_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ardupilot_msgs::srv::ArmMotors_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ardupilot_msgs
max_serialized_size_ArmMotors_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ardupilot_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_ArmMotors_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ardupilot_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_ArmMotors_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ardupilot_msgs::srv::ArmMotors_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ardupilot_msgs
max_serialized_size_key_ArmMotors_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ardupilot_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_ArmMotors_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ardupilot_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_ArmMotors_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const ardupilot_msgs::srv::ArmMotors_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ardupilot_msgs::srv::ArmMotors_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ArmMotors_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ardupilot_msgs::srv::ArmMotors_Event *>(
...
static size_t _ArmMotors_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ArmMotors_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ArmMotors_Event__callbacks = {
  "ardupilot_msgs::srv",
  "ArmMotors_Event",
...
static rosidl_message_type_support_t _ArmMotors_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ArmMotors_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &ardupilot_msgs::srv::typesupport_fastrtps_cpp::_ArmMotors_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ardupilot_msgs, srv, ArmMotors_Event)() {
  return &ardupilot_msgs::srv::typesupport_fastrtps_cpp::_ArmMotors_Event__handle;
}
...
static const rosidl_service_type_support_t _ArmMotors__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ArmMotors__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<ardupilot_msgs::srv::ArmMotors_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<ardupilot_msgs::srv::ArmMotors_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<ardupilot_msgs::srv::ArmMotors_Event>(),
