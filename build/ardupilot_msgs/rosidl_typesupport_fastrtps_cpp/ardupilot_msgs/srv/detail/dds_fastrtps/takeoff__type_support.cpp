...
#include "ardupilot_msgs/srv/detail/takeoff__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ardupilot_msgs::srv::Takeoff_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ardupilot_msgs::srv::Takeoff_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ardupilot_msgs::srv::Takeoff_Request *>(
    untyped_ros_message);
...
{
  return &ardupilot_msgs::srv::typesupport_fastrtps_cpp::_Takeoff_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ardupilot_msgs::srv::Takeoff_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ardupilot_msgs::srv::Takeoff_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ardupilot_msgs::srv::Takeoff_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ardupilot_msgs::srv::typesupport_fastrtps_cpp::_Takeoff_Response__handle;
}
...
// functions for ardupilot_msgs::srv::Takeoff_Request already declared above

// functions for ardupilot_msgs::srv::Takeoff_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ardupilot_msgs
cdr_serialize(
  const ardupilot_msgs::srv::Takeoff_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ardupilot_msgs::srv::Takeoff_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ardupilot_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_Takeoff_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ardupilot_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_Takeoff_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ardupilot_msgs::srv::Takeoff_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ardupilot_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_Takeoff_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ardupilot_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_Takeoff_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const ardupilot_msgs::srv::Takeoff_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ardupilot_msgs::srv::Takeoff_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ardupilot_msgs::srv::typesupport_fastrtps_cpp::_Takeoff_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ardupilot_msgs, srv, Takeoff_Event)() {
  return &ardupilot_msgs::srv::typesupport_fastrtps_cpp::_Takeoff_Event__handle;
}
...
static const rosidl_service_type_support_t _Takeoff__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<ardupilot_msgs::srv::Takeoff_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<ardupilot_msgs::srv::Takeoff_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<ardupilot_msgs::srv::Takeoff_Event>(),
...
{
  return &ardupilot_msgs::srv::typesupport_fastrtps_cpp::_Takeoff__handle;
}
