...
#include "ardupilot_msgs/msg/detail/global_position__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ardupilot_msgs::msg::GlobalPosition;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ardupilot_msgs
max_serialized_size_key_GlobalPosition(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const ardupilot_msgs::msg::GlobalPosition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ardupilot_msgs::msg::GlobalPosition *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GlobalPosition__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ardupilot_msgs::msg::GlobalPosition *>(
...
static size_t _GlobalPosition__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GlobalPosition(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GlobalPosition__callbacks = {
  "ardupilot_msgs::msg",
  "GlobalPosition",
...
static rosidl_message_type_support_t _GlobalPosition__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GlobalPosition__callbacks,
...
{
  return &ardupilot_msgs::msg::typesupport_fastrtps_cpp::_GlobalPosition__handle;
}
