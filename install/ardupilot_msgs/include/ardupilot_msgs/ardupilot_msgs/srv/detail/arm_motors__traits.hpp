...
inline std::string to_yaml(const ArmMotors_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use ardupilot_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const ardupilot_msgs::srv::ArmMotors_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  ardupilot_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use ardupilot_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const ardupilot_msgs::srv::ArmMotors_Event & msg)
{
  return ardupilot_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<ardupilot_msgs::srv::ArmMotors_Event>()
{
  return "ardupilot_msgs::srv::ArmMotors_Event";
}

template<>
inline const char * name<ardupilot_msgs::srv::ArmMotors_Event>()
{
  return "ardupilot_msgs/srv/ArmMotors_Event";
}

template<>
struct has_fixed_size<ardupilot_msgs::srv::ArmMotors_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<ardupilot_msgs::srv::ArmMotors_Event>
  : std::integral_constant<bool, has_bounded_size<ardupilot_msgs::srv::ArmMotors_Request>::value && has_bounded_size<ardupilot_msgs::srv::ArmMotors_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<ardupilot_msgs::srv::ArmMotors_Event>
  : std::true_type {};
