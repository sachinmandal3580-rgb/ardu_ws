...
#ifndef _WIN32
# define DEPRECATED__ardupilot_msgs__srv__Takeoff_Event __attribute__((deprecated))
#else
# define DEPRECATED__ardupilot_msgs__srv__Takeoff_Event __declspec(deprecated)
#endif
...
struct Takeoff_Event_
{
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<ardupilot_msgs::srv::Takeoff_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<ardupilot_msgs::srv::Takeoff_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<ardupilot_msgs::srv::Takeoff_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<ardupilot_msgs::srv::Takeoff_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<ardupilot_msgs::srv::Takeoff_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<ardupilot_msgs::srv::Takeoff_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<ardupilot_msgs::srv::Takeoff_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<ardupilot_msgs::srv::Takeoff_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    ardupilot_msgs::srv::Takeoff_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const ardupilot_msgs::srv::Takeoff_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<ardupilot_msgs::srv::Takeoff_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<ardupilot_msgs::srv::Takeoff_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      ardupilot_msgs::srv::Takeoff_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<ardupilot_msgs::srv::Takeoff_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      ardupilot_msgs::srv::Takeoff_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<ardupilot_msgs::srv::Takeoff_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<ardupilot_msgs::srv::Takeoff_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<ardupilot_msgs::srv::Takeoff_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__ardupilot_msgs__srv__Takeoff_Event
    std::shared_ptr<ardupilot_msgs::srv::Takeoff_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__ardupilot_msgs__srv__Takeoff_Event
    std::shared_ptr<ardupilot_msgs::srv::Takeoff_Event_<ContainerAllocator> const>
...
// alias to use template instance with default allocator
using Takeoff_Event =
  ardupilot_msgs::srv::Takeoff_Event_<std::allocator<void>>;
...
struct Takeoff
{
  ...
  using Event = ardupilot_msgs::srv::Takeoff_Event;
};
